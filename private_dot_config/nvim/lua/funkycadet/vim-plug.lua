...
Plug('L3MON4D3/LuaSnip') -- Added LuaSnip
...
Plug('sharkdp/fd')
Plug('nvim-telescope/telescope-fzf-native.nvim', { ['do'] = function() vim.fn.system('make') end })
...
Plug('microsoft/vscode-js-debug', { 
  -- ['tag'] = '1.77.0', 
  ['do'] = function() vim.fn.system('npm install --legacy-peer-deps && npx gulp vsDebugServerBundle') end 
})
-- Python
